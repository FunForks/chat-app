...
4. At this point, you can checkout the next official branch (`git checkout 2.0-add-poll-route`) and verify that your version has all the expected new features.
