...
4. At this point, you can checkout the next official branch (`git checkout 3.0-show-message-history`) and verify that your version has all the expected new features.
